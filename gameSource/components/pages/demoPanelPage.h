...
#ifndef INC_2HOL_DEMOPANEL_H
#define INC_2HOL_DEMOPANEL_H
...
#endif //INC_2HOL_DEMOPANEL_H



// shows panel until a correct code has been entered
// assumes font TGA in "graphics" folder
void showDemoCodePanel( OneLife::game::Application *inScreen, const char *inFontTGAFileName,
...
OneLife::game::Application *codeCheckerScreen;
...
static void panelCommonInit( OneLife::game::Application *inScreen, const char *inFontTGAFileName,
							 int inWidth, int inHeight ) {
...
void showWriteFailedPanel( OneLife::game::Application *inScreen, const char *inFontTGAFileName,
						   int inWidth, int inHeight ) {
	panelCommonInit( inScreen, inFontTGAFileName, inWidth, inHeight );
