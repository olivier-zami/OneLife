...
static void
trackETA(int inX, int inY, int inSlot, timeSec_t inETA, int inSubCont = 0, TransRecord *inApplicableTrans = NULL)
{
...
static int applyTapoutGradientRotate(int inX, int inY, int inTargetX, int inTargetY, int inEastwardGradientID)
{
...
static char runTapoutOperation(int inX,
	int                            inY,
	int                            inRadiusX,
	int                            inRadiusY,
	int                            inSpacingX,
